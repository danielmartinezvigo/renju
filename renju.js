...
class Renju {
  ...
  getHalfOpen4() {
    const patterns = [
      // (^|W|_)BB_BB($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])((?:\[B\(\d+,\d+\)\]){2}\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){2})(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)BBB_B($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])((?:\[B\(\d+,\d+\)\]){3}\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){1})(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)B_BBB($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])((?:\[B\(\d+,\d+\)\]){1}\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){3})(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W)BBBB_($|W|_)
      /(?:^|\[W\(\d+,\d+\)\])((?:\[B\(\d+,\d+\)\]){4}\[\.\(\d+,\d+\)\])(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)_BBBB($|W)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])(\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){4})(?:$|\[W\(\d+,\d+\)\])/mg,
      // (^|W|_)_BBBB_B
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])(\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){4})\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){1}/mg,
      // B_BBBB_(^|W|_)
      /(?:\[B\(\d+,\d+\)\]){1}\[\.\(\d+,\d+\)\]((?:\[B\(\d+,\d+\)\]){4}\[\.\(\d+,\d+\)\])(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)BB_BB_B
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])((?:\[B\(\d+,\d+\)\]){2}\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){2})\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){1}/mg,
      // B_BB_BB(^|W|_)
      /(?:\[B\(\d+,\d+\)\]){1}\[\.\(\d+,\d+\)\]((?:\[B\(\d+,\d+\)\]){2}\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){2})(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
    ];
    let result = [];
    this.getInternalLines().forEach(line => (
      patterns.forEach((pattern) => {
  ...
  getOpen3() {
    const patterns = [
      // (^|W|_)_BBB__($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])(\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){3}(?:\[\.\(\d+,\d+\)\]){2})(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)__BBB_($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])((?:\[\.\(\d+,\d+\)\]){2}(?:\[B\(\d+,\d+\)\]){3}\[\.\(\d+,\d+\)\])(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)_BB_B_($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])(\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){2}(?:\[\.\(\d+,\d+\)\]){1}(?:\[B\(\d+,\d+\)\]){1}\[\.\(\d+,\d+\)\])(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
      // (^|W|_)_B_BB_($|W|_)
      /(?:^|\[(?:W|\.)\(\d+,\d+\)\])(\[\.\(\d+,\d+\)\](?:\[B\(\d+,\d+\)\]){1}(?:\[\.\(\d+,\d+\)\]){1}(?:\[B\(\d+,\d+\)\]){2}\[\.\(\d+,\d+\)\])(?:$|\[(?:W|\.)\(\d+,\d+\)\])/mg,
    ];
    let result = [];
    this.getInternalLines().forEach(line => (
      patterns.forEach((pattern) => {
